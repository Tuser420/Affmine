$(document).ready(function() {
	...
	// Reward Name
	var $reward_1 = 'iPhone  13';
	
	// Reward Color Names
	var $color_1 = 'Silver';
	var $color_2 = 'Space Grey';
	
	// Capacity Names
	var $capacity_1 = '128<span class="small">GB</span>';
	var $capacity_2 = '256<span class="small">GB</span>';
		...
		$.ajax({
			...
			success: function(dataprocess){				
				...
				function resetfinishBoxes() {
					var $finish_list = $('.model-finish-inner-wrapper-r, .model-finish-inner-wrapper-l');	
				...
				$("#s-s-b").click(function() {
					...
					success: function(dataprocess){
						...
						function resetcapacityBoxes() {
							var $capacity_list = $('.model-capacity-inner-wrapper-r, .model-capacity-inner-wrapper-l');	
